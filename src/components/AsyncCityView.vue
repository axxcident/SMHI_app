<template>
  <div class="flex flex-col flex-1 items-center">
      ...
      <div class="mx-8 text-white">
        ...
        <div v-for="day in weatherData.daily" v-bind:key="day.dt" class="flex items-center">
          ...
          <img class="w-[50px] h-[50px] object-cover"
            v-bind:src="`http://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png`" alt="">
    ...
    <div class="flex items-center text-white gap-2 py-12 cursor-pointer duration-150 hover:text-red-500"
      @click="removeCity">
...
const getWeatherData = async () => {
  try {
    const weatherData = await axios(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&appid=2c024e0403e452fa20de57f8d17c4ad0&units=metric`);
